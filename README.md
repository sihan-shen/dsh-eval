...
- **DSH/Cordis:** this package does not mount a Cordis plugin itself. Its optimized evaluator consumes `@ds-plugins/dsh-code-intelligence`, whose compatibility target is DSH `0.1.1-rc.2` and Cordis `4.0.1`.

## Install

```sh
pnpm add @ds-plugins/dsh-eval @ds-plugins/dsh-context @ds-plugins/dsh-code-intelligence @ds-plugins/dsh-telemetry
```
...
The runtime dependencies are `@ds-plugins/dsh-context`, `@ds-plugins/dsh-code-intelligence`, `@ds-plugins/dsh-telemetry`, and `@dqbd/tiktoken`. DSH and Cordis are not direct runtime dependencies of this package.
